...
export const restedPassoword = () => {
    Swal.fire({
        title: "Cambia tu contraseña",
        input: "text",
        inputPlaceholder: "Estribe tu nueva contraseña",
        ...
        if (result.isConfirmed) {
            ...
            data.append("req", "change_password");
            data.append("password", result.value);
            ...
            if (event.key === "Enter") {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        postData("../../models/courses.php", editData).then((resp) => {
                            if (resp.code === "ok") {
                                Swal.fire(
                                    "Guardado!",
